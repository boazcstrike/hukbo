...
| --- | --- |
| `attack-great-blade.wav` | An agent attacks with a Great Blade |
| `attack-heavy-chopper.wav` | An agent attacks with a Heavy Chopper |
| `attack-thrusting-blade.wav` | An agent attacks with a Thrusting Blade |
| `attack-work-blade.wav` | An agent attacks with a Work Blade |
