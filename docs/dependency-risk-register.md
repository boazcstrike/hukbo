...
| NuGet feed unavailable | Clean restore fails | Package locks and CI cache | Keep CI restore evidence; do not vendor packages without a decision |
...
| Action tag moves | CI supply-chain risk | Workflow uses full commit SHAs | Review and deliberately update pins |
