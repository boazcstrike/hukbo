...
A later change on 2026-08-12 raised four of those 106 rows — the ones that
already had real generated files — from six declared variants to ten each, so
...
>
> **Superseded further on 2026-08-12.** The twenty-four files above became
> forty: the same four rows were raised from six declared variants to ten,
> and sixteen more files were generated to fill them. The rest of the
> catalog remains unauthorized, and the live account stays
