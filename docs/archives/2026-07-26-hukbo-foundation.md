...
**Files:**
- Create: `src/Hukbo.Core/Hukbo.Core.csproj`
- Create: `src/Hukbo.Headless/Hukbo.Headless.csproj`
- Create: `src/Hukbo.Client/Hukbo.Client.csproj`
- Create: `tests/Hukbo.Core.Tests/Hukbo.Core.Tests.csproj`
...
Run: `dotnet sln Hukbo.slnx list`, followed by
...
**Files:**
- Create: `tests/Hukbo.Core.Tests/DeterministicRandomTests.cs`
- Create: `tests/Hukbo.Core.Tests/FixedPointTests.cs`
- Create: `src/Hukbo.Core/Determinism/SplitMix64.cs`
- Create: `src/Hukbo.Core/Mathematics/FixedPoint.cs`
...
Run: `dotnet test tests/Hukbo.Core.Tests --filter FullyQualifiedName~DeterministicRandomTests`
...
- Create: `src/Hukbo.Core/Simulation/SimulationOptions.cs`
- Create: `src/Hukbo.Core/Simulation/Faction.cs`
...
- Create: `src/Hukbo.Core/Simulation/BattleSummary.cs`
...
Run: `dotnet test tests/Hukbo.Core.Tests -c Release`  
...
Run:
`dotnet run --project src/Hukbo.Headless -c Release -- --agents 200 --ticks 10000 --seed 1`
...
- Create: `src/Hukbo.Client/Content/Content.mgcb`
...
Run: `dotnet build src/Hukbo.Client -c Release`  
Expected: PASS.
