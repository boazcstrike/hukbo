...
| `{{PLAN}}` | `docs/plans/movement/kampilan.md` | `docs/plans/movement/wasay.md` | `docs/plans/movement/kalis.md` | `docs/plans/movement/itak.md` | `docs/plans/movement/tall-hardwood-shield.md` |
...
1. `docs/plans/movement/README.md` — the shared architecture, preset identity,
