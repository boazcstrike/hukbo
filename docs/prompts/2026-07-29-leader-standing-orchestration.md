...
| `docs/plans/2026-07-29-warrior-standing.md` | The task plan: Phase A (A1-A13), Phase B (B1-B3), and an explicit exclusion list |
...
- Map the standing surface named in `docs/plans/2026-07-29-warrior-standing.md`
