...
- At B0 the **entire pre-existing suite is green** and the seed-1 workload still reports
  `DC7F2E7A107C885A` and `6C641E90DDF0B943`, proving the T08 seam changed no value.
...
current 1081 ticks. That runs inside stage 4 of the canonical gate. The expectation is
