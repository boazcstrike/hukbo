# Orchestrated Autonomous Arena Execution Plan
...
**Architecture:** `AutonomousArena.Core` is the only authoritative gameplay layer. Headless and Client consume its stable scenario, snapshot, event, and hash contracts; the Client owns only scheduling, rendering, camera, UI, and application exit.
...
- Create: `src/AutonomousArena.Core/Simulation/AgentView.cs`
- Create: `src/AutonomousArena.Core/Simulation/AgentIntent.cs`
- Create: `src/AutonomousArena.Core/Simulation/BattleOutcome.cs`
...
```powershell
dotnet test tests/AutonomousArena.Core.Tests `
...
- Create: `src/AutonomousArena.Headless/HeadlessRunner.cs`
- Create: `src/AutonomousArena.Headless/RunReport.cs`
...
```powershell
dotnet run --project src/AutonomousArena.Headless -c Release -- `
...
- Create: `src/AutonomousArena.Client/InputEdges.cs`
- Modify: `src/AutonomousArena.Client/Content/Content.mgcb`
- Create: `src/AutonomousArena.Client/Content/Default.spritefont`
...
```powershell
dotnet build src/AutonomousArena.Client -c Release
```
...
- Create: `src/AutonomousArena.Client/MenuOverlay.cs`
- Create: `src/AutonomousArena.Client/MenuButton.cs`
- Modify: `src/AutonomousArena.Client/ArenaGame.cs`
- Modify: `src/AutonomousArena.Client/InputEdges.cs`
