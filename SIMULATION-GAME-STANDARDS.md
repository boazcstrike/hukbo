...
Do not add rigid-body physics in v0.1; distance checks and hitscan are enough.
...
New systems declare their stage; incidental call order never decides outcomes.
...
| `Body` | radius | Positive; used for display/range, not rigid-body collision |
